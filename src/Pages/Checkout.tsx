...
const Checkout = () => {
    return (
        <>
            <div>
                <Header />
                <div className="w-full h-max pt-24 py-4">
                    <div className="w-full h-10 flex items-center pl-20 phone:pl-5">
                    ...
                    <div className="w-full h-[90%]  px-20 phone:px-5">
                        <div className="w-full h-16 items-center justify-center hidden">
                        ...
                        <div className="w-full h-[90%] flex phone:flex-col justify-between">
                            <div className="w-[73%] phone:w-full border border-pry p-4 rounded h-full">
                                <div className="w-full h-[60%] ">
                                    ...
                                    <div className="w-full h-[69%]  flex">
                                        <div className="w-72 h-60 p-2 rounded">
                                ...
                                <div className="w-full h-[30%] p-4">
                                    ...
                                    <div className="w-full h-[70%] flex phone:flex-col items-center justify-between gap-7">
                                        <div className="w-[50%] h-[90%] phone:w-full bg-slate-50 rounded flex p-4">
                                ...
                                <div className="w-full h-[10%] flex justify-between items-center">
                                    <button className="w-36 h-10 phone:h-14 flex items-center rounded-md bg-pry justify-center text-white">
                                        Back To Cart
                                    </button>
                                    <button className="w-44 h-10 phone:h-14 flex items-center rounded-md bg-teal-500 justify-center text-white">
                                        Continue to payment
                                    </button>
                                </div>
                            </div>
                            <div className="w-[25%] phone:w-full shadow rounded h-full p-4 flex flex-col gap-5">
