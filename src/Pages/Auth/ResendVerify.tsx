            ...
            <div className="w-full h-screen bg-gray-200 flex justify-center">
                <div className="h-full w-[90%]">
                    <div className="w-full h-[8%]">
                        <img src={Logo} alt="" className="h-full w-[8%] ph:w-32 object-contain"/>
                    </div>
                    <div className="w-full flex items-center justify-center h-[80%]">
                        <div className="w-[50%] ph:w-[90%] flex flex-col justify-around items-center h-[60%] ph:h-[70%] bg-white">
                            <div className="w-full flex items-center justify-around flex-col h-1/2">
                                <label htmlFor="email">
                                    Input Email for verification code
                                </label>
                                <input
                                    className="w-[70%] ph:w-[90%] h-10 pl-2 rounded outline-none border border-solid border-[#3F51B5]"
                                    style={{
                                        border: `${
