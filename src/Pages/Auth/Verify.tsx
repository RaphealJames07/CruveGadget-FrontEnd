        ...
        <>
            <div className="w-full h-screen bg-gray-200 flex justify-center">
                <div className="w-[90%] h-full">
                    ...
                    <div className="w-full flex items-center justify-center flex-col h-[80%] phone:h-[90%]">
                        <div className="w-3/5 flex flex-col justify-around items-center h-1/2 phone:h-[60%] phone:w-[90%]">
                            <h1 className="text-3xl phone:w-full phone:text-center">
                                Authenticate Your Account!
                            </h1>
                            <p className="text-center text-sm w-4/5 phone:w-full">
                            ...
                            <div
                                ...
                                className="flex justify-between w-[30%] h-[15%] phone:h-[10%] phone:w-[60%]"
                                onPaste={handlePaste}
                            >
                            ...
                            <button
                                className="bg-indigo-700 w-40 h-12 rounded text-white text-base cursor-pointer border-none disabled:bg-indigo-400 disabled:cursor-not-allowed"
                            ...
                            <p className="phone:w-full phone:text-center">
                        ...
                        <div className="w-full flex items-center justify-center h-[10%]">
                            <button
                                ...
                                className="w-32 h-12 rounded-md cursor-pointer text-sm bg-none border-2 border-solid border-[#3F51B5]"
                            >
                                Back to Login
                            </button>
                        </div>
