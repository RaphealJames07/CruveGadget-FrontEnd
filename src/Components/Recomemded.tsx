    ...
    return (
        <>
            <div className="w-full h-max py-5">
                ...
                <div className="w-full h-max py-4 px-20 phone:px-5 flex justify-between gap-10 phone:gap-5 overflow-x-auto">
                    <div className="w-max h-max flex justify-between gap-10 phone:gap-5">
