...
const Footer = () => {
    return (
        <>
            <div className="w-full h-max flex flex-col px-20 phone:px-5 bg-[#1f1f1f] py-10 phone:py-5 text-white">
                <div className="w-full h-80 phone:h-max flex justify-between phone:flex-col">
                    <div className="w-80 phone:w-full h-full py-5 flex flex-col gap-5">
                    ...
                    <div className="w-80 phone:w-full h-full py-5 flex flex-col ">
                    ...
                    <div className="w-80 phone:w-full h-full py-5 flex flex-col justify-between">
                ...
                <div className="w-full h-20 phone:h-max flex phone:flex-col justify-between items-center">
                    <div className="w-max flex items-center gap-5 phone:flex-col underline underline-offset-4">
                    ...
                    <div className=" phone:h-14 w-max flex items-center">
